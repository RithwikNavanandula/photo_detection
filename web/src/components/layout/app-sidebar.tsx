...
const NAV: NavItem[] = [
  ...
  { href: "/all-transfers", label: "All Transfers", icon: ClipboardList, permission: "manage_transfers" },
  { href: "/pending-requests", label: "Pending Requests", icon: Clock3, permission: "manage_transfers" },
  { href: "/receive-confirmations", label: "Receive Confirmations", icon: FileText, permission: "receive_transfer" },
