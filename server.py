...
Uses local SQLite for user/inventory data
"""
...
# Scan photos live next to the DB so a persistent disk keeps them across deploys
...
def get_db():
    """Open local SQLite with WAL for better concurrent reads."""
